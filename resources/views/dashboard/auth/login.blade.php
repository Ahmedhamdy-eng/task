...
<div class="login-box">
    ...
    <div class="login-logo">
        <a href="{{ asset('dashboard_files/index2.html') }}"><b>Creative</b>Minds</a>
    </div><!-- end of login lgo -->

    <div class="login-box-body">
        <p class="login-box-msg">Sign in to start your Mession</p>
        ...
        <form action="{{ route('dashboard.login') }}" method="post">
            ...
            <div class="form-group">
                <label style="font-weight: normal;"><input type="checkbox" name="remember"> @lang('remember_me')</label>
            </div>
